export const API_KEY = '8394baa64abbd91ac68f379166ca4022';

const request = {
	requestMovieDetails: `https://api.themoviedb.org/3/movie/`,
	...
	requestMovieSearch: `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}&language=en-US&page=1&include_adult=false`,
};
